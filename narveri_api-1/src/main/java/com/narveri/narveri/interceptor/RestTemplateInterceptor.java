package com.narveri.narveri.interceptor;


import com.narveri.narveri.model.RestWsLog;
import com.narveri.narveri.service.RestWsLogService;
import com.narveri.narveri.util.JsonUtil;
import com.narveri.narveri.util.SpringApplicationContext;
...
public class RestTemplateInterceptor implements ClientHttpRequestInterceptor {
    ...
    public ClientHttpResponse intercept(HttpRequest request, byte[] body, ClientHttpRequestExecution execution) throws IOException {
        ...
        try {
            ...
            log.info("infor on restWsLog: {}", restWsLog.toString());
